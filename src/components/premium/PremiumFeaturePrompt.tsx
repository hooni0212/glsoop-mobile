...
const styles = StyleSheet.create({
  ...
  eyebrow: { fontSize: 11, fontWeight: "600", letterSpacing: 1, color: tokens.colors.green700 },
  title: { fontSize: 22, lineHeight: 29, fontWeight: "600", color: tokens.colors.text },
  ...
  benefitText: { flex: 1, fontSize: 13, lineHeight: 19, fontWeight: "500", color: tokens.colors.text },
  ...
  primaryBtnText: { fontSize: 14, fontWeight: "600", color: tokens.colors.textInverse },
  secondaryBtn: { minHeight: 42, alignItems: "center", justifyContent: "center" },
  secondaryBtnText: { fontSize: 13, fontWeight: "500", color: tokens.colors.textMuted },
