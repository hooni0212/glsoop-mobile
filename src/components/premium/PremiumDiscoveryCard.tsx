      ...
      >
        ...
        <Text style={styles.description}>
          {isPremium
            ...
            : "광고 없는 사진 저장, 프로필 사진, 글 이미지 작가 서명과 문장 액자를 만나보세요."}
        </Text>
...
const styles = StyleSheet.create({
  ...
  main: { flex: 1, gap: 4 },
  pressed: { opacity: 0.7 },
  eyebrow: { fontSize: 10, fontWeight: "600", letterSpacing: 0.9, color: tokens.colors.green700 },
  title: { fontSize: 16, lineHeight: 22, fontWeight: "600", color: tokens.colors.text },
  description: { fontSize: 12, lineHeight: 18, fontWeight: "500", color: tokens.colors.textMuted },
  actionRow: { marginTop: 3, flexDirection: "row", alignItems: "center", gap: 5 },
  actionText: { fontSize: 12, fontWeight: "600", color: tokens.colors.green700 },
